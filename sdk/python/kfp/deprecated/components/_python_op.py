...
def _func_to_component_spec(func,
    ...
    Args:
        ...
        base_image: Optional. Docker image to be used as a base image for the python component. Must have python 3.5+ installed. Default is python:3.8
...
def func_to_component_text(func,
    ...
    Args:
        ...
        base_image: Optional. Specify a custom Docker container image to use in the component. For lightweight components, the image needs to have python 3.5+. Default is python:3.8
    ...
    Examples:
        The function name and docstring are used as component name and description. Argument and return annotations are used as component input/output types::
            ...
            add_op = create_component_from_func(
                func=add,
                base_image='python:3.8', # Optional
